  ...
  <main id="main">
    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="section-title">What We Sales</h3>
        </header>
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel clients-carousel md-5">
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <a href="#location"> <h3>Address</h3> </a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-5 footer-info">
            <a href="#intro"> <img style="height: 50px; width: 150px;" src="Images/smart.png"> </a>
